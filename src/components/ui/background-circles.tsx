...
const AnimatedGrid = () => (
    ...
    >
        <div className="h-full w-full [background-image:repeating-linear-gradient(100deg,#AABEC7_0%,#AABEC7_1px,transparent_1px,transparent_4%)] opacity-10" />
    </motion.div>
);
...
export function BackgroundCircles({
    ...
    return (
        ...
        >
            ...
            <motion.div className="absolute inset-0 m-auto h-[480px] w-[480px]">
                {[0, 1, 2].map((i) => (
                    <motion.div
                        key={i}
                        className={clsx(
            ...
            <div className="absolute inset-0 [mask-image:radial-gradient(90%_60%_at_50%_50%,#000_40%,transparent)]">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(81,117,137,0.12),transparent_70%)] blur-[120px]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(170,190,199,0.08),transparent)] blur-[80px]" />
            </div>
        </div>
    );
}
